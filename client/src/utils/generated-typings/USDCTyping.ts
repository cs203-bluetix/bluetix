...
export type ContractContext = Web3ContractContext<
  USDCTyping,
  USDCTypingMethodNames,
  USDCTypingEventsContext,
  USDCTypingEvents
>;
export type USDCTypingEvents = 'Approval' | 'OwnershipTransferred' | 'Transfer';
export interface USDCTypingEventsContext {
  Approval(
    parameters: {
...
export type USDCTypingMethodNames =
  | 'new'
  | 'DOMAIN_SEPARATOR'
  | 'EIP712_REVISION'
  | 'PERMIT_TYPEHASH'
...
export interface USDCTyping {
   ...
   * Type: function
   */
  EIP712_REVISION(): MethodConstantReturnContext<string>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   */
  mint(account: string, value: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   ...
   * @param value Type: uint256, Indexed: false
   */
  mint(value: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
