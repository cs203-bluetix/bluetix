...
import compiledSessionFactory from "../compiledContract/contracts/SessionFactory.sol/SessionFactory.json" assert {type:'json'}
...
async function main() {
  ...
  const contract = new ethers.Contract("0x52D800ca262522580CeBAD275395ca6e7598C014",USDC,"");
